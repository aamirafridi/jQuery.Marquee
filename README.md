...
Update (21 Aug 2013):
---------------------
If you want to hide the marquee for certain devices, try using ``` visibility: hidden``` instead of ``` display: none``` because jQuery cannot calculate with width etc of hidden elements.
For more details: 
